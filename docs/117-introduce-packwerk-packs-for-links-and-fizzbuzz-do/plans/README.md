...
- [02-create-packs.md](02-create-packs.md) — Move domain files into packs/links, packs/fizzbuzz, and packs/surveys, create package.yml with enforcement on, verify at each step
...
| `QrCodeGenerator` stays at root | Generic utility used by both fizzbuzz and links; surveys has no dependency on it; moving it to links creates an architecturally odd dependency |

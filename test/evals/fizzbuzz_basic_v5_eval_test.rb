...
class FizzbuzzBasicV5EvalTest < EvalTestCase
  ...
  teardown do
    EvalFixtureWriter.append(@eval_dir, @runs, sample_labels: @sample_labels, prompt_label: "fizzbuzz_basic_v5")
  end
  ...
  def run_eval(sample_key)
    prompt = fizzbuzz_prompts(:fizzbuzz_basic_v5)
